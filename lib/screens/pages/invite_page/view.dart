...
class InviteScreen extends GetView<InviteCon> {
  ...
  Widget build(BuildContext context) {
    ...
    final subtittle="They get a chance to avail discount on booking and you earn \$30.00 in YBride credits. Your code will be created after you first booking.";
    final referralSubtitle = "Generate a referral code and invite your friend through the link.If he/she download and sign-up  using your referral code, you will get a \$30 discount from YB-Ride on your next checkout ";
    ...
    return Obx((){
      return Scaffold(
        ...
        body: controller.state.loading.value ? Container(
          child: Center(child: Lottie.asset('assets/lottie/loading2.json',height: 200,width: 200)),
        ): controller.state.carBooked.value==false ? Container(
          child: Column(
            children: [
              SizedBox(
                height: mq.height * .06,
