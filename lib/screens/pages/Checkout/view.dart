  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      return controller.state.paymentLoading.value==true ? Scaffold(
        ...
        body: Center(
          child: Container(
            child: Lottie.asset('assets/lottie/loading2.json',height: 200,width: 200),
          ),
        ),
      ) :
              ...
              children: [
                ...
                Obx(() {
                  return controller.state.vehicle_delivery.value ==
                      true ||
                      controller.state.vehicle_pickup.value == true
                      ? Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                      ...
                      children: [
                        ...
                        Obx(
                            ...
                            onChanged: (bool? value) {
                              ...
                              if (value == true) {
                                controller.addInTotalPrice(
                                    controller.state.unlimitedMiles,true);
                              } else if (value == false) {
                                controller.subtractFromTotalPrince(
                                    controller.state.unlimitedMiles,true);
                              }
                ...
                Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Image(
                          image: AssetImage('assets/images/signals.jpeg'),
                          height: mq.height * .05,
                          width: mq.width * .05,
                        ),
                        SizedBox(width: 8),
